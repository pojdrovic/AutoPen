class sensor_actual_engine_torque : public sensor
{
public:
	int get_mode() { return 0x01; }
	int get_pid() { return 0x62; }
	std::string get_symbol() { return "actual_engine_torque"; }
	std::string get_unit() { return "%"; }
	std::string get_description() { return "actual engine torgue"; }
