class sensor_o2s6_wr_lambda_voltage : public sensor
{
public:
	int get_mode() { return 0x01; }
	int get_pid() { return 0x29; }
	std::string get_symbol() { return "o2s6_wr_lambda_voltage"; }
	std::string get_unit() { return ""; }
	std::string get_description() { return "O2S 6 WR lambda voltage"; }
