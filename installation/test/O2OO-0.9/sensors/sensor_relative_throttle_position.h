class sensor_relative_throttle_position : public sensor
{
public:
	int get_mode() { return 0x01; }
	int get_pid() { return 0x45; }
	std::string get_symbol() { return "relative_throttle_position"; }
	std::string get_unit() { return "%"; }
	std::string get_description() { return "relative throttle position"; }
