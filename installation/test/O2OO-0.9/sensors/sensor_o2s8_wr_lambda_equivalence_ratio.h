class sensor_o2s8_wr_lambda_equivalence_ratio : public sensor
{
public:
	int get_mode() { return 0x01; }
	int get_pid() { return 0x2b; }
	std::string get_symbol() { return "o2s8_wr_lambda_equivalence_ratio"; }
	std::string get_unit() { return ""; }
	std::string get_description() { return "O2S 8 WR lambda equivalence ratio"; }
