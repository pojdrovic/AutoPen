class sensor_commanded_egr : public sensor
{
public:
	int get_mode() { return 0x01; }
	int get_pid() { return 0x2c; }
	std::string get_symbol() { return "commanded_egr"; }
	std::string get_unit() { return "%"; }
	std::string get_description() { return "commanded egr purge"; }
