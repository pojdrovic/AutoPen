class sensor_commanded_throttle_actuator : public sensor
{
public:
	int get_mode() { return 0x01; }
	int get_pid() { return 0x4c; }
	std::string get_symbol() { return "commanded_throttle_actuator"; }
	std::string get_unit() { return "%"; }
	std::string get_description() { return "commanded throttle actuator"; }
